...
The next step is to simply mount the lab's GoPro and collect data. I intend to collect data over a coverage area that I can compose them into a mosaic,
...
Using a hollow rod and zip ties, I mounted the GoPro such that I can attach to the boat to point downward while underwater. 
I want this to be removable so that I can easily collect data from the EMILY or just from a manned boat or kayak. 
