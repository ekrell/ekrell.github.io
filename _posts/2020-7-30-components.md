...
[UAVcast Cellular Telemetry](https://ardupilot.org/copter/docs/common-uavcast-telemetry.html). I only came across this today, when I saw [David Boulanger using it](https://ardupilot.org/copter/docs/common-uavcast-telemetry.html) for his ArduPilot boat. It is designed for MAVLink telemetry over 3G or 4G. 
